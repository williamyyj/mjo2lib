...
package hyweb.jo.org.apache.log4j;
...
import hyweb.jo.org.apache.log4j.config.PropertySetter;
import hyweb.jo.org.apache.log4j.helpers.FileWatchdog;
import hyweb.jo.org.apache.log4j.helpers.LogLog;
import hyweb.jo.org.apache.log4j.helpers.OptionConverter;
import hyweb.jo.org.apache.log4j.or.RendererMap;
import hyweb.jo.org.apache.log4j.spi.Configurator;
import hyweb.jo.org.apache.log4j.spi.Filter;
import hyweb.jo.org.apache.log4j.spi.LoggerFactory;
import hyweb.jo.org.apache.log4j.spi.LoggerRepository;
import hyweb.jo.org.apache.log4j.spi.OptionHandler;
import hyweb.jo.org.apache.log4j.spi.RendererSupport;
import hyweb.jo.org.apache.log4j.spi.ThrowableRenderer;
import hyweb.jo.org.apache.log4j.spi.ThrowableRendererSupport;
import hyweb.jo.org.apache.log4j.spi.ErrorHandler;
...
/**
   ...
   support custom {@link hyweb.jo.org.apache.log4j.spi.ErrorHandler ErrorHandlers},
...
public class PropertyConfigurator implements Configurator {
  ...
  /** *  Key for specifying the {@link hyweb.jo.org.apache.log4j.spi.LoggerFactory
  ...
  /**
   ...
   converted to String before being logged. This is done by
   specifying an {@link hyweb.jo.org.apache.log4j.spi.ThrowableRenderer ThrowableRenderer}.
...
new PropertyConfigurator().doConfigure(inputStream,
  ...
  */
  ...
  /**
     ...
     {@link hyweb.jo.org.apache.log4j.spi.LoggerFactory LoggerFactory}
  ...
  */
          ...
          if (hierarchy instanceof ThrowableRendererSupport) {
            ThrowableRenderer tr = (ThrowableRenderer)
                  OptionConverter.instantiateByKey(props,
                          ...
                          hyweb.jo.org.apache.log4j.spi.ThrowableRenderer.class,
                          null);
            if(tr == null) {
                LogLog.error(
  ...
  Appender parseAppender(Properties props, String appenderName) {
    ...
    appender = (Appender) OptionConverter.instantiateByKey(props, prefix,
					      hyweb.jo.org.apache.log4j.Appender.class,
					      null);
    if(appender == null) {
      LogLog.error(
